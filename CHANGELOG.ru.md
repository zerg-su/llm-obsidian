...
- Regression покрывает полный переход от trust dialog к настоящему редактору.
  Live ratchet scripts сдвинут на точную production-стоимость в пять строк —
  до 296 файлов / 113 208 строк без спекулятивного запаса.
