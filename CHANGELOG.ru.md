...
- Findings Deep review этого handoff применены в том же owner: worktree-packet
  пишется зарегистрированным writer'ом для этого артефакта, поэтому публикация
  больше не ужимает caller-owned корень checkout с 0755 до 0700; size guard
