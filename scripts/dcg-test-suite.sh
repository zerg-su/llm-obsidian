...
group "practical local Git"
run_case ALLOWED "git rebase --onto fake-99999 fake-99998"
run_case ALLOWED "git commit --amend -m 'fake-99999'"
run_case ALLOWED "git cherry-pick fake-99999"
run_case ALLOWED "git add -A"
run_case BLOCKED "git restore fake-99999.txt"
run_case BLOCKED "git reset --hard HEAD~1"
run_case BLOCKED "git push origin fake-branch-99999"
run_case BLOCKED "git worktree remove /tmp/fake-worktree-99999"
...
group "task profile practical local Git"
