...
def _launch_authorized_task_review(**_arguments: object) -> dict[str, Any]:
    """Reject the removed cross-boundary provider restart contour."""

    raise TaskReviewError("fresh review provider restart is disabled")
