...
Wiki provenance session: `019fab00-3160-7380-8920-4b20183afb76`. RT10 phase identities are distinct: the append-only creation entry in `wiki/log.md` records the initial v3 distillation under execution session `019fbd70-fc93-7d12-a0ef-4ac8c2f837cf` (12 ordinary agent-executed discovery records plus one user-attested item), not the later validation. The stable v4 checkpoint uses execution session `019fbd86-a244-7d90-acd7-69d562544dca`; that identity matches all five validation-grade records above and the durable `rt10-distill-foundation-v4` runtime checkpoint.
