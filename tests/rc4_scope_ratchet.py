...
measured production cost is one file and 435 lines, so the live ceiling is
pinned to exactly 296 files / 112,817 lines with no speculative headroom.
"""
