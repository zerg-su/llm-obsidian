...
identity-bound write-ahead stages plus thread/process linearization. The exact
 ...
 coalesced-separator recovery fix, so the live ceiling is pinned to exactly
 296 files / 112,826 lines with no speculative headroom.
"""
