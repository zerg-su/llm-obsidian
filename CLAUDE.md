...
Этот репозиторий — одновременно Claude Code плагин и Obsidian-вольт. Открой каталог как вольт в Obsidian, работай с ним из Claude Code, и вики будет расти по мере того как ты с чем-то сталкиваешься, что-то узнаёшь или планируешь.
